...
if(OPTION_ANVIRT_EMU)
  # copy from android_build_qemu_variant(), and change to android_add_library
  function(android_build_qemu_variant_as_shared)
    # Parse arguments
    set(options INSTALL)
    set(oneValueArgs CPU EXE)
    set(multiValueArgs SOURCES DEFINITIONS LIBRARIES)
...
if(OPTION_ANVIRT_EMU)
  function(android_add_anvirt_emu_executable ANDROID_AARCH STUBS)
    android_build_qemu_variant_as_shared(
      INSTALL
      EXE qemu-system-${ANDROID_AARCH}-anvirt-emu
      CPU ${ANDROID_AARCH}
      SOURCES ${STUBS} android-qemu2-glue/main.cpp vl.c
      DEFINITIONS
        -DNEED_CPU_H -DCONFIG_ANDROID
